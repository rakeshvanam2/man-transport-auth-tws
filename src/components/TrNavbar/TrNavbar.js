...
const TrNavbar = ( props ) => {
    const { email} = props.logUser;
    return (
        <div className='container'>
            <nav className="navbar navbar-expand-lg navbar-light">
                <div className="container-fluid">
                    <div>
                       <Link to='/home'><img className='w-50' src="https://www.threeway.studio/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo.d93e7f38.png&w=64&q=75" alt=""/></Link> 
